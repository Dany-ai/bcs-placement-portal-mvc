<section class="section section-narrow">
    ...
    <form method="post" action="<?= URL_ROOT ?>/employer/updatePlacement/<?= (int)$placement['id'] ?>" class="form">
        <label>
            Placement Title
        ...
        <label>
            ...
            <textarea name="skills_required" rows="3" placeholder="PROG:3, TEST:2, ARCH:4"><?= htmlspecialchars($placement['skills_required']) ?></textarea>
        </label>
