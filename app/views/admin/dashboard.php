<section class="section admin-dashboard-padding">
                ...
                <?php foreach ($pendingPlacements as $p): ?>
                    <li>
                        ...
                        <div class="card-actions" style="margin-top:0.5rem;">
                            <form method="post"
                                  action="<?= URL_ROOT ?>/admin/approvePlacement/<?= (int)$p['id'] ?>"
                            ...
                            <form method="post"
                                  action="<?= URL_ROOT ?>/admin/rejectPlacement/<?= (int)$p['id'] ?>"
                                  style="display:inline;"
    ...
    <!-- Career Support / Student Chat card -->
                ...
                <?php foreach ($students as $s): ?>
                    <tr>
                        ...
                        <td style="text-align:right;">
                            <a href="<?= URL_ROOT ?>/admin/chatStudent/<?= (int)$s['user_id'] ?>"
